...
function (_Component) {
  ...
  function SouvenirForm() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "nextPage", function () {
      var newPage = document.getElementById(); // Why you do not use simple document.getElementById('yourid').setAttribute('style', 'color: red') 
    });
...
//# sourceMappingURL=index.js.12c97f293dd3ea428565.hot-update.js.map