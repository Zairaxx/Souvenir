...
})(["@import url('https://fonts.googleapis.com/css?family=Lobster');@import url('https://fonts.googleapis.com/css?family=Abril+Fatface|Amatic+SC:700|Lobster');font-family:'LobsterAbril Fatface',cursive;font-size:3rem;color:#BFF;text-align:center;"]);
...
})(["display:flex;flex-direction:column;justify-content:space-around;align-items:center;background:#000;min-width:100vw;min-height:105vh;position:absolue;"]);
var scrollArrow = Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["keyframes"])(_templateObject());
...
var ScrollDown = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].span.withConfig({
  displayName: "Hero__ScrollDown",
  componentId: "sc-1kp3y8c-3"
})(["animation:", " 1s linear infinite;"], scrollArrow);
...
var Hero = function Hero() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(HeroBg, {
    ...
    __self: this
  }, " - Enchance your memories ")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ScrollDown, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 54
    },
...
//# sourceMappingURL=index.js.75d56bebe19e9678afa9.hot-update.js.map