...
function (_Component) {
  ...
  function SouvenirForm() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "nextPage", function () {
      ...
      var buttonAction = document.getElementById('next-page');
      buttonAction.setAttribute('style', "display:none"); //For Firefox
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "prevPage", function () {
      ...
      buttonAction.setAttribute('style', "display:auto");
    });
...
//# sourceMappingURL=index.js.b0e6c0add4c724fdc4f2.hot-update.js.map