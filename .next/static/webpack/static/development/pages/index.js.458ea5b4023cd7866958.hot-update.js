...
function (_Component) {
  ...
  function SouvenirForm() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "nextPage", function () {
      document.getElementById('pageTwo').setAttribute('style', ''); // document.getElementById('yourid').setAttribute('style', 'color: red') 
    });
...
//# sourceMappingURL=index.js.458ea5b4023cd7866958.hot-update.js.map