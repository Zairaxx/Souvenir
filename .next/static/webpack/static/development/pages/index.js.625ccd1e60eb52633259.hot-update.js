...
function (_Component) {
  ...
  function SouvenirForm() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSubmit", function (e) {
      ...
      var mountNode = react__WEBPACK_IMPORTED_MODULE_0___default.a.findDOMNode(_this.refs.mount);

      try {
        react__WEBPACK_IMPORTED_MODULE_0___default.a.unmountComponentAtNode(_this.refs.mount);
      } catch (e) {
        console.error(e);
      }

      document.getElementById("submit-souvenir").style.display = "none";
    });
...
//# sourceMappingURL=index.js.625ccd1e60eb52633259.hot-update.js.map