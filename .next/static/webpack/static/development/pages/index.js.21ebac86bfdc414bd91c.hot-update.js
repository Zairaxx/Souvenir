...
function (_Component) {
  ...
  function SouvenirForm() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "nextPage", function () {
      document.getElementById('pageTwo').setAttribute('style', 'left'); // document.getElementById('yourid').setAttribute('style', 'color: red') 
    });
...
//# sourceMappingURL=index.js.21ebac86bfdc414bd91c.hot-update.js.map