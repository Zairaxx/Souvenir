...
})(["@import url('https://fonts.googleapis.com/css?family=Oswald');font-family:'Oswald',cursive;font-size:5.6rem;color:#FFF;text-align:center;"]);
...
})(["display:flex;flex-direction:column;justify-content:space-around;align-items:center;background-image:linear-gradient(to bottom right,#041030,#243B55);min-width:100vw;min-height:100vh;"]);
...
})(["position:relative;background:#000;min-width:100vw;min-height:100vh;"]);
...
})(["@import url('https://fonts.googleapis.com/css?family=Abril+Fatface|Amatic+SC:700|Lobster');font-family:'Amatic SC',cursive;color:white;text-align:center;border:1px white solid;padding:20px"]);
...
//# sourceMappingURL=index.js.6381e1517ea5eedb9869.hot-update.js.map