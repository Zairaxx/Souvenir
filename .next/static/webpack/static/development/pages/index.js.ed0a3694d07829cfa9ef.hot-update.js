...
function (_Component) {
  ...
  function SouvenirForm() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "nextPage", function () {
      document.getElementById('pageTwo').setAttribute(); // document.getElementById('yourid').setAttribute('style', 'color: red') 
    });
...
//# sourceMappingURL=index.js.ed0a3694d07829cfa9ef.hot-update.js.map