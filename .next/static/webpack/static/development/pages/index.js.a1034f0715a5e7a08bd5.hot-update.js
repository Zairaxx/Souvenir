...
})(["border:1px black solid;background-color:", ";display:", ";position:", ";flex-direction:", ";align-items:", ";justify-content:", ";width:", ";height:", ";top:", ";min-width:", ";left:", ";right:", ";"], function (props) {
...
})(["border:1px black solid;background-color:", ";display:", ";position:", ";flex-direction:", ";align-items:", ";justify-content:", ";width:", ";top:", ";min-width:", ";left:", ";right:", ";overflow:hidden;z-index:", ";"], function (props) {
  return props.bgColor || "auto";
}, function (props) {
  return props.display || "flex";
}, function (props) {
...
})(["display:flex;width:13px;height:13px;background-color:", ";border:1px solid black;margin-left:5px;border-radius:3px;cursor:pointer;animation:", " 3s infinite linear;&:hover{border:3px solid black;}"], function (props) {
...
function (_Component) {
  ...
  function SouvenirForm() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "nextPage", function () {
      document.getElementById('pageTwo').setAttribute('style', 'animation: ${slideIn} 2s infinite linear');
      console.log("hi");
    });
  ...
  _createClass(SouvenirForm, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Flex, {
        ...
        __self: this
      }, this.state.audio)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(FlexSlider, (_React$createElement = {
        id: "pageTwo",
        zIndex: "2",
        position: "absolute",
        height: "100%",
        ...
        fileName: _jsxFileName,
        lineNumber: 126
      }), _defineProperty(_React$createElement, "__self", this), _React$createElement), "Heya"));
    }
  }]);
...
//# sourceMappingURL=index.js.a1034f0715a5e7a08bd5.hot-update.js.map