...
})(["@import url('https://fonts.googleapis.com/css?family=Oswald');font-family:'Oswald',cursive;font-size:5.6rem;color:#B0B0F0;text-align:center;"]);
...
})(["display:flex;flex-direction:column;justify-content:space-around;align-items:center;background:#141E30;background:-webkit-linear-gradient(to bottom right,#243B55,#041A30);background:linear-gradient(to bottom right,#243B55,#141E30);min-width:100vw;min-height:100vh;"]);
...
})(["background:#000;min-width:100vw;min-height:100vh;"]);
...
//# sourceMappingURL=index.js.fb0287409dfbbf50e34c.hot-update.js.map