...
function (_Component) {
  ...
  function SouvenirForm() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "nextPage", function () {
      ...
      document.getElementById('flex-slider-wrapper').setAttribute('style', 'padding:0 0 30vh 0; overflow:visible');
      console.log("hi");
    });
...
//# sourceMappingURL=index.js.9547b4313d1ef6658ede.hot-update.js.map