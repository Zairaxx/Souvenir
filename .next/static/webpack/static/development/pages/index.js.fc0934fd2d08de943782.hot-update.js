...
function (_Component) {
  ...
  function SouvenirForm() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "nextPage", function () {
      ...
      buttonAction.setAttribute('onClick', 'prevPage()'); //For Firefox

      buttonAction.onclick = function (prevPage) {
        prevPage();
      }; // For IE7
...
//# sourceMappingURL=index.js.fc0934fd2d08de943782.hot-update.js.map