...
})(["display:flex;width:13px;height:13px;background-color:", ";border:1px solid black;margin-left:5px;border-radius:3px;cursor:", ";&:hover{border:3px solid black;}"], function (props) {
  return props.color || "white";
}, function (props) {
  return props.cursor || "white";
});
...
//# sourceMappingURL=index.js.2c685aaea3a826fd3f0e.hot-update.js.map