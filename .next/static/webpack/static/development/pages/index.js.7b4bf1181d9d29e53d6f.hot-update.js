...
})(["border:1px black solid;background-color:", ";display:", ";position:", ";flex-direction:", ";align-items:", ";justify-content:", ";width:", ";top:", ";min-width:", ";left:", ";right:", ";overflow:hidden;animation:", " 1s 2 alternate;z-index:", ";"], function (props) {
  return props.bgColor || "auto";
}, function (props) {
  return props.display || "flex";
}, function (props) {
...
function (_Component) {
  ...
  function SouvenirForm() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "nextPage", function () {
      document.getElementById('pageTwo').setAttribute('style', 'left: 0'); // document.getElementById('yourid').setAttribute('style', 'color: red') 
    });
...
//# sourceMappingURL=index.js.7b4bf1181d9d29e53d6f.hot-update.js.map